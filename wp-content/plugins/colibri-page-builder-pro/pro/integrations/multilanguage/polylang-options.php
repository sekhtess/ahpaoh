  ...
  <script>
    function colibri_multilanguage_copy_from_source() {
      var data = {
        ...
        source_post: <?php echo $defaultID; ?>,
        destination_post: <?php echo $post->ID; ?>,
...
add_action( 'wp_ajax_colibri_copy_from_source', function ($data) {
    ...
    $source_post_id = isset($_REQUEST['source_post']) ? $_REQUEST['source_post'] : null;
    $destination_post_id = isset($_REQUEST['destination_post']) ? $_REQUEST['destination_post'] : null;
