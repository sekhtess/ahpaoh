...
== Changelog ==
= Version 2.0.4 | 28 Aug 2020 =
* Added: dismiss notice button in Elementor addon notice 
* Fixed:Conflict with ACF Pro plugin
* Fixed:minor conflict with woocommerce 
* improved:removed body class

= Version 2.0.3 | 25 Aug 2020 =
* Fixed:nonce verification security error
= Version 2.0.2 | 10 Aug 2020 =
* Fixed:Re-rendering issue mentioned by user
* Fixed:compatibility issue with WordPress 5.5
* Fixed:Fixed custom styling default settings issues
* Fixed:Story popup small images issue

= Version 2.0.1 | 10 July 2020 =
* Updated:Wrong links

= Version 2.0 | 08 May 2020 =
* Added: Integrated Visual Composer builder support
* Added: Added notice for Elementor widget addon
* Added: Added Icon support in Horizontal Timeline
* Updated: Updated Cool Timeline Settings
* Fixed: Story small image blur issue
* Fixed: Custom CSS before/after CSS not working issues
* Fixed: Popup responsive issues
* Fixed: text overlapping issues
* Fixed: title alignments issues
* Imporved: Review notices and messages
