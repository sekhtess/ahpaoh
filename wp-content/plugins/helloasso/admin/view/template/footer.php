<div class="ha-footer">
  <svg xmlns="http://www.w3.org/2000/svg" id="Calque_1" viewBox="0 0 200 43.5" class="ha-logo-footer">
    <style>
      .st0{fill:#2e2f5e}
    </style>
  ...
  <div class="ha-copyright">Tous droits réservés © <?= date('Y'); ?> - HelloAsso for Wordpress v1.1.2</div>
</div>